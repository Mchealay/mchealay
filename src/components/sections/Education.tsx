      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-10 sm:mb-12">
          ...
          <motion.div
            ...
            className="lg:col-span-2 glass gradient-border rounded-2xl p-5 sm:p-6 md:p-8 flex flex-col justify-between"
          >
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-sm sm:text-base text-slate-300 font-semibold">Mekelle University</p>
              </div>
            ...
            {/* Metrics Chips */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 pt-6 mt-6 border-t border-white/8">
              <div className="p-3 sm:p-3.5 rounded-xl bg-white/5 border border-white/8">
                <span className="text-[11px] sm:text-xs text-slate-400 uppercase tracking-widest block font-mono">
                  Cumulative GPA
                </span>
                <span className="text-xl sm:text-3xl font-extrabold text-cyan-400 mt-1 block">
              ...
              <div className="p-3 sm:p-3.5 rounded-xl bg-white/5 border border-white/8">
                ...
                <span className="text-xl sm:text-3xl font-extrabold text-emerald-400 mt-1 block">
                  86.25%
                </span>
              </div>
            </div>
